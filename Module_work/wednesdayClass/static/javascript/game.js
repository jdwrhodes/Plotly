...
var theGameObject = new Phaser.Game(config);
...
function create() {
    ...
    // platforms.create(Math.floor(Math.random() * 150), Math.floor(Math.random() * 150), 'platform');
